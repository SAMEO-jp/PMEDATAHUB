...
graph TB
    %% メインページ
    ZissekiPage[ZissekiPage<br/>page.tsx] --> EventProvider[EventProvider<br/>context/EventContext.tsx]
    EventProvider --> ZissekiPageContent[ZissekiPageContent<br/>page.tsx]
    
    %% 状態管理
    ZissekiPageContent --> ZissekiStore[useZissekiStore<br/>store/zissekiStore.ts]
    ZissekiPageContent --> EventContext[useEventContext<br/>context/EventContext.tsx]
    ZissekiPageContent --> WorkTimeReducer[useWorkTimeReducer<br/>hooks/reducer/useWorkTimeReducer.ts]
    
    %% メインコンテンツ
    ZissekiPageContent --> TimeGrid[TimeGrid<br/>components/weekgrid/TimeGrid.tsx]
    ZissekiPageContent --> ZissekiSidebar[ZissekiSidebar<br/>components/sidebar/ZissekiSidebar.tsx]
    
    %% TimeGrid の子コンポーネント
    TimeGrid --> EventDisplay[EventDisplay<br/>components/weekgrid/components/EventDisplay.tsx]
    TimeGrid --> TimeSlot[TimeSlot<br/>components/weekgrid/components/TimeSlot.tsx]
    
    %% ZissekiSidebar の子コンポーネント
    ZissekiSidebar --> ConditionalContent[ConditionalContent<br/>components/sidebar/components/ConditionalContent.tsx]
    ZissekiSidebar --> ProjectSubTabs[ProjectSubTabs<br/>components/sidebar/selectors/ProjectSubTabs.tsx]
    ZissekiSidebar --> IndirectSubTabs[IndirectSubTabs<br/>components/sidebar/selectors/IndirectSubTabs.tsx]
    
    %% ConditionalContent の子コンポーネント
    ConditionalContent --> ProjectCodeDisplay[ProjectCodeDisplay<br/>components/sidebar/components/ProjectCodeDisplay.tsx]
    ConditionalContent --> ProjectDetailTabs[ProjectDetailTabs<br/>components/sidebar/tabs/ProjectDetailTabs.tsx]
    ConditionalContent --> IndirectDetailTabs[IndirectDetailTabs<br/>components/sidebar/tabs/IndirectDetailTabs.tsx]
    ConditionalContent --> EquipmentSelector[EquipmentSelector<br/>components/sidebar/selectors/EquipmentSelector.tsx]
    ConditionalContent --> PurchaseItemSelector[PurchaseItemSelector<br/>components/sidebar/selectors/PurchaseItemSelector.tsx]
    ConditionalContent --> EventDetailForm[EventDetailForm<br/>components/sidebar/forms/EventDetailForm.tsx]
    
    %% タブコンテンツ
    ConditionalContent --> PlanningTabContent[PlanningTabContent<br/>components/sidebar/tabs/content/PlanningTabContent.tsx]
    ConditionalContent --> DesignTabContent[DesignTabContent<br/>components/sidebar/tabs/content/DesignTabContent.tsx]
    ConditionalContent --> MeetingTabContent[MeetingTabContent<br/>components/sidebar/tabs/content/MeetingTabContent.tsx]
    ConditionalContent --> OtherTabContent[OtherTabContent<br/>components/sidebar/tabs/content/OtherTabContent.tsx]
    
    %% セレクター
    ProjectCodeDisplay --> ProjectSelect[ProjectSelect<br/>components/sidebar/selectors/ProjectSelect.tsx]
...
│   │   │   └── ProjectCodeDisplay.tsx
│   │   ├── selectors/                # セレクター
│   │   │   ├── ProjectSubTabs.tsx
│   │   │   ├── IndirectSubTabs.tsx
│   │   │   ├── ProjectSelect.tsx
│   │   │   ├── EquipmentSelector.tsx
│   │   │   └── PurchaseItemSelector.tsx
│   │   ├── tabs/                     # タブ関連
│   │   │   ├── ProjectDetailTabs.tsx
│   │   │   ├── IndirectDetailTabs.tsx
│   │   │   └── content/              # タブコンテンツ
│   │   │       ├── PlanningTabContent.tsx
│   │   │       ├── DesignTabContent.tsx
│   │   │       ├── MeetingTabContent.tsx
│   │   │       └── OtherTabContent.tsx
│   │   └── forms/                    # フォーム
│   │       └── EventDetailForm.tsx
│   ├── weekgrid/                     # 時間グリッド関連
