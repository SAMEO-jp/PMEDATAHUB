    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="bg-purple-50 p-3 rounded-lg text-xs">
                  <h6 className="font-medium text-purple-800 mb-2">設計理由:</h6>
                  <ul className="space-y-1 text-purple-700">
                    <li>• <strong>多対多関係</strong>: 1つのプロジェクトに複数メンバー、1人のユーザーが複数プロジェクトに参加</li>
                    <li>• <strong>ロール管理</strong>: PM/開発者/設計者/テスター/閲覧者の権限レベルを明確化</li>
                    <li>• <strong>参加履歴</strong>: joined_at/left_atでメンバーの参加・退任時期を追跡</li>
                    <li>• <strong>任命者記録</strong>: assigned_byで誰がメンバーを任命したかを記録</li>
                    <li>• <strong>一意性制約</strong>: (project_id, user_id)で重複参加を防止</li>
                  </ul>
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="bg-orange-50 p-3 rounded-lg text-xs">
                  <h6 className="font-medium text-orange-800 mb-2">設計理由:</h6>
                  <ul className="space-y-1 text-orange-700">
                    <li>• <strong>監査ログ</strong>: 全変更操作を記録し、コンプライアンス要件に対応</li>
                    <li>• <strong>変更追跡</strong>: old_value/new_valueで変更前後の値を保持</li>
                    <li>• <strong>操作分類</strong>: action_typeでCREATE/UPDATE/DELETE等を分類</li>
                    <li>• <strong>責任者特定</strong>: changed_byで変更者を明確化</li>
                    <li>• <strong>時系列管理</strong>: changed_atで変更時刻を正確に記録</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div className="text-center mt-12 pt-8 border-t">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link href="/specifications/doc2-kentosho-management">
            <button className="border border-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-50 transition-colors">
              検討書管理システム仕様書
            </button>
          </Link>
