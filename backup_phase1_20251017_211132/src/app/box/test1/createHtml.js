...
<body>
    ...
    // HTMLファイルを保存
    fs.writeFileSync(path.join(__dirname, 'file_data_table.html'), htmlContent, 'utf8');
    console.log('HTMLファイルが作成されました: file_data_table.html');
